...
- [ ] Unit test(s): backspace at list start removes list formatting and preserves text
- [ ] UI test: create bullet, move caret to start of item content, backspace => becomes paragraph
- [ ] Behavior works for bullet, task, ordered
