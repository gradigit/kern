...
- [ ] All native-editor sources required to build are tracked
- [ ] All tests/fixtures/scripts required to run `./scripts/test-native-editor.sh --unit-only` are tracked
- [ ] Output directories (ex: `test-results/`) are ignored and not committed
