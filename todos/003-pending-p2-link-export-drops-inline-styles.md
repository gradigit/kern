...
- [ ] Add unit test(s) demonstrating styled link round-trip (bold link label at minimum)
- [ ] Export preserves link label styles without corrupting surrounding inline styles
- [ ] Golden fixture added for the case
