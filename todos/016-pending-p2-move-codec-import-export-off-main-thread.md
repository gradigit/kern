...
- [ ] Opening and typing in `native-editor-benchmark.md` does not freeze the UI noticeably
- [ ] Perf test (gated) establishes a budget (time + memory) and stays under it
- [ ] No race conditions in export/import pipeline
