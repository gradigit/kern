...
- [ ] Unit test: `orderedTasksEnabled=true` recognizes `1. [ ] ` as ordered task
- [ ] UI test: typing `1. [ ] ` converts to checkbox without requiring extra chars
- [ ] Ensure invalid patterns (ex: `1. [a] text`) do not become tasks
