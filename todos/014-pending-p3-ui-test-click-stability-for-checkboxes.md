...
- [ ] UI tests have stable checkbox toggling across window sizes and appearances
- [ ] If using test-only hit-target override, add a unit test that still verifies the default hit-target behavior separately
