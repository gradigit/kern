...
- [ ] Decide on whether `CoreEditor/dist` is tracked or built as part of the app build
- [ ] In the chosen approach, a clean checkout can build and run Kern without missing `dist` resources
- [ ] Add a guardrail (CI or script) that prevents `index.html` from referencing missing assets
