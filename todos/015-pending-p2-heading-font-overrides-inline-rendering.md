...
- [ ] Add fixture/test for heading containing inline code and/or emphasis
- [ ] Editor visually renders inline code as monospaced inside heading
- [ ] Export remains deterministic and round-trips the fixture
