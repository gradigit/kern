...
A remote image that should load if network access works:

![1.00](https://placehold.co/600x150/007aff/ffffff?text=Kern+Editor+Image+Test)

A second image to verify multiple loads:

![1.00](https://placehold.co/400x100/34c759/ffffff?text=Second+Image)
...
## Ordered Lists (Nested Numbering: 1 → a → i)
